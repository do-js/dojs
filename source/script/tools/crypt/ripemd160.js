 ...
 * @param s 输入的字符串
 */
module.exports.hex_rmd160 = function(s){
	return hex_rmd160(s);
};
 ...
 * @param s 输入的字符串
 */
module.exports.b64_rmd160 = function(s){
	return b64_rmd160(s);
};
 ...
 * @param s 输入的字符串
 */
module.exports.any_rmd160 = function(s){
	return any_rmd160(s);
};

//---------------------------------------------------------------
/**
 * 密钥相关的rmd160算法，16进制格式输出
 * @param k 秘钥key
 * @param d 输入的字符串
 */
module.exports.hex_hmac_rmd160 = function(k, d){
	return hex_hmac_rmd160(k, d);
};

//---------------------------------------------------------------
/**
 * 密钥相关的rmd160算法，Base64格式输出
 * @param k 秘钥key
 * @param d 输入的字符串
 */
module.exports.b64_hmac_rmd160 = function(k, d){
	return b64_hmac_rmd160(k, d);
};

//---------------------------------------------------------------
/**
 * 密钥相关的rmd160算法，原始字符串格式输出
 * @param k 秘钥key
 * @param d 输入的字符串
 * @param e encoding编码
 */
module.exports.any_hmac_rmd160 = function(k, d, e){
